...
## Git & GitHub (CRITICAL)
Git is already initialized and the remote is configured to push to `electric-apps/room-coder-fox-7024538c`.
The GitHub repo has been created at: https://github.com/electric-apps/room-coder-fox-7024538c
...
```bash
git add -A
git commit -m "chore: scaffold room-coder-fox-7024538c"
...
- Do NOT push to any repository other than `electric-apps/room-coder-fox-7024538c`
